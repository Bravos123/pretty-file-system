...
"mouseup";"ontouchstart"in document.documentElement&&(c="touchend");a.element.addEventListener(c,function(c){c.stopPropagation();void 0==b.draging||0==b.mouseDrag?(e(b.selectedItem),a.open?(a.open=!1,a.elemContainer.style.display="none",c=a.element.getElementsByTagName("div")[0],c.getElementsByTagName("div")[0].className="fileExplorerImagePreview fileExplorerFolderClosed fileExplorerContainBack",c.className="fileExplorerItem",b.selectedItem=d):(a.open=!0,a.elemContainer.style.display="block",c=a.element.getElementsByTagName("div")[0],
...
function(b){b.stopPropagation();u.open(a)},!1)};this.addListenerToFile=function(a){var v="mouseup";"ontouchstart"in document.documentElement&&(v="touchend");a.element.addEventListener(v,function(h){h.stopPropagation();b.holding=!1;void 0==b.draging||0==b.mouseDrag?(e(b.selectedItem),b.selectedItem.id==a.id&&void 0!=b.selectedItem?(b.selectedItem=d,a.element.className="fileExplorerItem"):(b.selectedItem=void 0!=b.selectedItem?a:d,c.onClickFile(a.name,a.id,a.image),a.element.className="fileExplorerItemSelectedColor",
